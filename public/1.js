...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../api */ "./resources/js/src/api/index.js");
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return _api__WEBPACK_IMPORTED_MODULE_2__["Order"].store({
                  ...
                  _this.$notify("success", "Sucesso!", "Os Tickets foram reservados para ".concat(_this.order.name), {
                    duration: 3000,
                    permanent: false
                  });
                  ...
                  _this.$notify("error", "Error!", "Não foi possível concluir", {
                    duration: 3000,
                    permanent: false
                  });
                });
                    ...
                    [
                      _c("b-input", {
                        attrs: {
                          type: "text",
                          name: "order.name",
                          state: _vm.$v.order.name.$error ? false : null,
                          placeholder: "Nome e sobrenome"
                        },
                        model: {
                          value: _vm.$v.order.name.$model,
                          callback: function($$v) {
                            _vm.$set(_vm.$v.order.name, "$model", $$v)
                          },
                          expression: "$v.order.name.$model"
                        }
                      }),
                      _vm._v(" "),
                      !_vm.$v.order.name.require
                    ...
                    [
                      _c("b-input", {
                        ...
                        attrs: {
                          type: "text",
                          name: "order.phone",
                          state: _vm.$v.order.phone.$error ? false : null,
                          placeholder: "(99) 99999-999"
                        },
                        model: {
                          value: _vm.$v.order.phone.$model,
                          callback: function($$v) {
                            _vm.$set(_vm.$v.order.phone, "$model", $$v)
                          },
                          expression: "$v.order.phone.$model"
                        }
                      }),
                      _vm._v(" "),
                      !_vm.$v.order.phone.require
                        ? _c("b-form-invalid-feedback", [
                            _vm._v(
